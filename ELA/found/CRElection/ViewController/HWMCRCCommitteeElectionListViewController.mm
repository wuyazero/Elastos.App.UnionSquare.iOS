...
- (void)viewDidLoad {
    ...
    self.TagtatolVoteLab.text=NSLocalizedString(@"最大表决票权：", nil);
...
- (IBAction)TheAverageDistributionImageViewEvent:(id)sender {
    ...
    self.TheAverageDistributionButton.selected=!self.TheAverageDistributionButton.selected;
    if (self.TheAverageDistributionButton.selected) {
