...
-(void)createPageControl{
    ...
    [_pageControl setValue:[UIImage imageNamed:@"switch_white"] forKeyPath:@"pageImage"];
    [_pageControl setValue:[UIImage imageNamed:@"switch_golden"] forKeyPath:@"currentPageImage"];
...
//    DLog(@"我要展示中间图");
    ...
    if (self.scrollImageIndex) {
        self.scrollImageIndex(self.currentImageIndex);
    }
}
...
//        UIView *view = [[UIView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width*3, self.frame.size.height*0.5)];
