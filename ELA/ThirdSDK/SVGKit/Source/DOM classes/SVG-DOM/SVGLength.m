...
+(float) pixelsPerInchForCurrentDevice
{
	...
	|| [platform hasPrefix:@"iPhone5"]
       || [platform hasPrefix:@"iPhone6"]|| [platform hasPrefix:@"iPhone7"]|| [platform hasPrefix:@"iPhone8"]|| [platform hasPrefix:@"iPhone6s"]|| [platform hasPrefix:@"iPhone7s"]|| [platform hasPrefix:@"iPhone8s"])
		return 326.0f;
...
//        DDLogCWarn(@"[%@] WARNING: you are running on the simulator; it's impossible for us to calculate centimeter/millimeter/inches units correctly", [self class]);
		return 132.0f;
        // Simulator, running on desktop machine
	}
