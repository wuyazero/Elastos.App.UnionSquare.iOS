...
- (BOOL)wo_addObserver:(id)object KVOinfo:(WOCPKVOInfo *)KVOinfo
{
    ...
    if(isHas) {
        ...
        //WYLog(@"crash add observer: %@, keyPath: %@", object, KVOinfo);
...
- (void)observeValueForKeyPath:(nullable NSString *)keyPath ofObject:(nullable id)object change:(nullable NSDictionary<NSKeyValueChangeKey, id> *)change context:(nullable void *)context{
    //WYLog(@"KVOProxy - observeValueForKeyPath :%@",change);
    __block WOCPKVOInfo *info ;
    {
        [self lock];
...
//    //WYLog(@"KVOProxy dealloc removeAllObserve");
}
